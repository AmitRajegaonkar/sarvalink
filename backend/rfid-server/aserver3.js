...
let latestUID = ""; // Store the latest UID received

// Endpoint to receive UID from RFID scanner
app.post('/uid', (req, res) => {
    latestUID = req.body.uid || ""; // Update the global variable
    const key_uid = req.body.key_uid || "";
    const event = req.body.event || "";

    console.log(`Received UID: ${latestUID}, Key UID: ${key_uid}, Event: ${event}`);
  
    res.send(`UID: ${latestUID}, Key UID: ${key_uid}, Event: ${event}`);
});
